    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-auto text-primary">
                ...
                <div class="fs-20 fw-300 pt-2">- Yes we are the right team for your gutter cleaning job!</div>
            </div>
            <div class="col-auto">
                <div class="row">
                    <div class="col-auto">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="row">
                    <div class="col-4"><?= renderImg('accreditiation-1.jpg', 'lib', 'w-100 rounded-8') ?></div>
                    <div class="col-4"><?= renderImg('accreditiation-2.jpg', 'lib', 'w-100 rounded-8') ?></div>
                    <div class="col-4"><?= renderImg('accreditiation-3.jpg', 'lib', 'w-100 rounded-8') ?></div>
                </div>
            </div>
        </div>
    </div>
